...
class MultImageTest extends StatefulWidget {
  @override
  _MultImageStateTest createState() => _MultImageStateTest();
}

class _MultImageStateTest extends State<MultImageTest> {
  ...
  final Map<String, ModelInfo> models = {
    "yolovl_kaggle_6cls.torchscript": ModelInfo(classNumber: 6, labelPath: "assets/labels/lb4.txt"),
    "yolovx_kaglle_6cls.torchscript": ModelInfo(classNumber: 6, labelPath: "assets/labels/lb4.txt"),
    "yolovm_kaggle_6cls.torchscript": ModelInfo(classNumber: 6, labelPath: "assets/labels/lb4.txt"),
    "yolovs_kaggle_6cls.torchscript": ModelInfo(classNumber: 6, labelPath: "assets/labels/lb4.txt"),
    "best_optimized.torchscript": ModelInfo(classNumber: 14, labelPath: "assets/labels/lb2.txt"),
    "souvik_only_banana.torchscript": ModelInfo(classNumber: 1, labelPath: "assets/labels/souvik_only_banana.txt"),
    "souvik_banana_filtered.torchscript": ModelInfo(classNumber: 1, labelPath: "assets/labels/souvik_only_banana.txt"),
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 10), // Provides some spacing between the label and dropdown
                                  DropdownButton<String>(
                                    isExpanded: true, // Ensures the dropdown is as wide as its parent
                                    value: selectedModel,
                                    ...
                                    onChanged: (String? newValue) {
                                      setState(() {
                                        ...
                                        loadModel().then((_) {
                                          // Optionally, re-run object detection with the new model
                                        });
                                      });
                                    },
                                    items: models.keys.map<DropdownMenuItem<String>>((String value) {
...
class ModelInfo {
  ...
  ModelInfo({required this.classNumber, required this.labelPath});
}
